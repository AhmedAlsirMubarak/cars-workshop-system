...
<head>
    ...
    <title>{{ $title ?? 'Workshop Pro' }} — Workshop Pro</title>
...
<div class="flex h-screen overflow-hidden" x-data="sidebar()">
    ...
    <aside :class="[
        ...
        <div class="flex items-center h-16 px-4 border-b border-gray-800 shrink-0 gap-3">
            <div class="w-8 h-8 rounded-lg bg-orange-500 flex items-center justify-center shrink-0 shadow shadow-orange-500/30">
                <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/>
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2 2h10l2-2z"/>
                </svg>
            </div>
        ...
        <div class="border-t border-gray-800 p-3 space-y-1 shrink-0">
            <div :class="['flex items-center gap-3 px-2 py-2', !open ? 'lg:justify-center' : '']">
                <div class="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center font-semibold text-sm shrink-0">
        ...
        <header class="h-16 bg-white border-b border-gray-100 flex items-center gap-3 px-4 sm:px-6 shrink-0 sticky top-0 z-10">
            ...
            <div x-data="dropdown()" class="relative">
                <button @click="toggle()" class="flex items-center gap-2 p-1 rounded-xl hover:bg-gray-100 transition">
                    <div class="w-8 h-8 rounded-full bg-orange-500 text-white flex items-center justify-center font-semibold text-sm">
                        {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                    </div>
